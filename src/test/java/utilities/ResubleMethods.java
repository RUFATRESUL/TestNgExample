...
public class ResubleMethods {
    ...
    public static String getScreenshot(String name) throws IOException {
        //naming the screenshot with the current date to avoid dublication
        String date = new SimpleDateFormat("yyMMddhhmmss").format(new Date());
        //Take screenshot is an interface of selenium that takes the screeshoot
    ...
    //=========Screenshot Web Element(Webelementin fotosunu almaq)========
    public static String getScreenshotWebelement(String name, WebElement element) throws IOException {
        ...
        //TakeScreenshoots is an interface of selenium that takes screenshot
        File source = element.getScreenshotAs(OutputType.FILE);
        //full path to the screenshot location
        String wElements = System.getProperty("user.dir") + "/target/WElementScreenshot/"+ name + date + ".png";
        File finalDestination = new File(wElements);
        //save the screenshot to the path given
        FileUtils.copyFile(source,finalDestination);
        return wElements;
    }
