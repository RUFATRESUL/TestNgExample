...
public abstract class TestBaseRaport {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("Browser", ConfigReader.getPropertie("browser")); // chrome, firefox
    ...
    public void tearDownMethod(ITestResult result) throws IOException {
        if (result.getStatus() == ITestResult.FAILURE) { // eğer testin sonucu başarısızsa
            ...
            String screenshotLocation = ResubleMethods.getScreenshot(result.getName());
